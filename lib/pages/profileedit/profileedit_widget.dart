...
class _ProfileeditWidgetState extends State<ProfileeditWidget> {
  ...
  void initState() {
    ...
    _model.myAddressTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.address, ''));
    _model.myAddressFocusNode ??= FocusNode();
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: AuthUserStreamWidget(
                  builder: (context) => TextFormField(
                    controller: _model.myAddressTextController,
                    focusNode: _model.myAddressFocusNode,
                    ...
                    maxLines: 3,
                    validator: _model.myAddressTextControllerValidator
                        .asValidator(context),
                  ),
                ),
              ),
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await currentUserReference!.update(createUsersRecordData(
                        ...
                        address: _model.myAddressTextController.text,
