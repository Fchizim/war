...
import 'trans_order_model.dart';
export 'trans_order_model.dart';

class TransOrderWidget extends StatefulWidget {
  const TransOrderWidget({super.key});

  @override
  State<TransOrderWidget> createState() => _TransOrderWidgetState();
}

class _TransOrderWidgetState extends State<TransOrderWidget> {
  late TransOrderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransOrderModel());
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            FlutterFlowDropDown<String>(
                              ...
                              options: const ['Long bus', 'Sienna', 'bus'],
                              onChanged: (val) =>
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            await TransRecord.collection
                                .doc()
                                .set(createTransRecordData(
                                  user: currentUserReference,
                                  destination:
                                      _model.addressTextController.text,
                                  pickLocation:
                                      _model.destinationTextController.text,
                                  departDate: _model.dateTextController.text,
                                  phoneNumber: _model.phoneTextController.text,
                                  createdTime: getCurrentTimestamp,
                                  displayName: _model.nameTextController.text,
                                  provider: _model.dropDownValue,
                                ));

                            context.pushNamed('transCheckout');
                          },
                          text: 'Book',
