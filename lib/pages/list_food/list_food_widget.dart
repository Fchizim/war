          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                StreamBuilder<List<FoodOrderRecord>>(
                  stream: queryFoodOrderRecord(
                    queryBuilder: (foodOrderRecord) =>
                        foodOrderRecord.orderBy('created_time'),
                  ),
                  builder: (context, snapshot) {
                    ...
                    List<FoodOrderRecord> listViewFoodOrderRecordList =
                        snapshot.data!;
                    return ListView.builder(
                      padding: EdgeInsets.zero,
                      shrinkWrap: true,
                      scrollDirection: Axis.vertical,
                      itemCount: listViewFoodOrderRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewFoodOrderRecord =
                            listViewFoodOrderRecordList[listViewIndex];
                        return Padding(
