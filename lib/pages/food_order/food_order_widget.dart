...
class _FoodOrderWidgetState extends State<FoodOrderWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FoodOrderModel());
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await FoodOrderRecord.collection
                                .doc()
                                .set(createFoodOrderRecordData(
                                  user: currentUserReference,
                                  displayName: _model.nameTextController.text,
                                  location: _model.addressTextController.text,
                                  orderDetail: _model.textController4.text,
                                  phoneNumber: _model.phoneTextController.text,
                                  createdTime: getCurrentTimestamp,
                                ));

                            context.pushNamed('foodcheckout');
